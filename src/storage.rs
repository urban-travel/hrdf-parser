...
pub struct DataStorage {
    ...
    bit_field_id_for_through_service_by_journey_id_stop_id: FxHashMap<(i32, i32, i32), i32>,
...
fn create_bit_field_id_through_service_by_journey_id_stop_id(
    ...
    through_services
        ...
        .fold(FxHashMap::default(), |mut acc, through_service| {
            let journey_id_1 = through_service.journey_1_id();
            let journey_id_2 = through_service.journey_2_id();
            ...
            acc.insert((journey_id_1, journey_id_2, journey_stop_id), bit_field_id);
            acc
        })
}
